...
public class UpdateAuctionListingValidator : AbstractValidator<UpdateAuctionListingCommand>
{
    public UpdateAuctionListingValidator()
    {
        RuleFor(x => x.UpdateDto).NotNull().WithMessage("Auction listing request is null");
        RuleFor(x => x.ListingId)
            .NotEmpty().WithMessage("Auction id is empty")
            .NotNull().WithMessage("Auction id is null")
